...
namespace NetEmulator
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(Images.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(Images.AirSpeedNeedle);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            double alphaNeedle = InterpolPhyToAngle(airSpeed,0,16,180,468);
