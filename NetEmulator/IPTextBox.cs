...
namespace iptb
{
	...
	public class IPTextBox: System.Windows.Forms.UserControl
	{
        ...
        //Added by george 1.10 to allign Ip addreses
        public string AllignLiteral(string literal)
        {
            if (literal.Length > 3)
                throw new Exception("IP literal can't be more than 3 digits.");
            if (literal.Length == 3)
            {
                if (literal == "000")
                    return "0";
                else if (literal.Substring(0, 2) == "00")
                    return literal.Substring(2);
                else if (literal.Substring(0, 1) == "0")
                    return literal.Substring(1, 2);
                return literal;
            }
		...
		public override string Text
		{
			get 
			{
                return AllignLiteral(Box1.Text) + "." + AllignLiteral(Box2.Text) + "." + AllignLiteral(Box3.Text) + "." + AllignLiteral(Box4.Text);
			}
			set
			{
				if (value != "" && value != null)
		...
		private void InitializeComponent()
		{
            ...
            this.Box4.Location = new System.Drawing.Point(88, 4);
            ...
            // Box3
            // 
            this.Box3.AcceptsTab = true;
            this.Box3.BorderStyle = System.Windows.Forms.BorderStyle.None;
            this.Box3.Location = new System.Drawing.Point(60, 4);
            ...
            this.Box2.Location = new System.Drawing.Point(32, 4);
            ...
            this.Name = "IPTextBox";
            this.Size = new System.Drawing.Size(123, 26);
